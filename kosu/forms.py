...
class kosu_divisionForm(forms.ModelForm):
  class Meta:
    ...
    widgets = {'kosu_name': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               ...
               'kosu_division_1_1': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_1': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_2': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_2': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_2': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_3': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_3': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_3': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_4': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_4': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_4': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_5': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_5': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_5': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_6': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_6': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_6': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_1': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_1': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_1': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_2': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               ...
               'kosu_division_1_7': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_7': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_8': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_8': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_8': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_9': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_9': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_9': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_10': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_10': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_10': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_11': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_11': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_11': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_12': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_12': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_12': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_13': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_13': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_13': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_14': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_14': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_14': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_15': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_15': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_15': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_16': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_16': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_16': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_17': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_17': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_17': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_18': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_18': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_18': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_19': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_19': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_19': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_20': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_20': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_20': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_21': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_21': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_21': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_22': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_22': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_22': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_23': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_23': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_23': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_24': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_24': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_24': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_25': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_25': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_25': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_26': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_26': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_26': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_27': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_27': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_27': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_28': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_28': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_28': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_29': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_29': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_29': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_30': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_30': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_30': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_31': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_31': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_31': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_32': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_32': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_32': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_33': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_33': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_33': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_34': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_34': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_34': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_35': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_35': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_35': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_36': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_36': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_36': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_37': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_37': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_37': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_38': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_38': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_38': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_39': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_39': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_39': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_40': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_40': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_40': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_41': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_41': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_41': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_42': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_42': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_42': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_43': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_43': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_43': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_44': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_44': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_44': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_45': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_45': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_45': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_46': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_46': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_46': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_47': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_47': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_47': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_48': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_48': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_48': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_49': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_49': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_49': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_title_50': forms.TextInput(attrs={'class' : 'form-control custom-border', 'style' : 'width: 200px;'}),
               'kosu_division_1_50': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'}),
               'kosu_division_2_50': forms.Textarea(attrs={'class' : 'form-control custom-border', 'style' : 'width: 300px;'})}
